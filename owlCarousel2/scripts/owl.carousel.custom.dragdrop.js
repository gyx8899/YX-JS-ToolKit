...
;(function($, window, document, undefined) {
	...
	Owl.prototype.registerEventHandlers = function() {
		...
		if (this.settings.mouseDrag) {
			...
			var that = this;
			this.$stage.on('dragend.owl.core', function () {
				that.$element.removeClass(that.options.dragClass);
				that.$element.removeClass(that.options.grabClass);
			});
			this.$stage.on('selectstart.owl.core', function() { return false });
		}
