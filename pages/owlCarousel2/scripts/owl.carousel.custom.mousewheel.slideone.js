...
;(function($, window, document, undefined) {
	 ...
	 * @returns {Number}
	 */
	Navigation.prototype.getPosition = function(successor, slideByOne) {
		var position, length,
			settings = this._core.settings;

		if (settings.slideBy == 'page' && !slideByOne) {
			...
			var step = slideByOne ? 1 : settings.slideBy;
			successor ? position += step : position -= step;
		}
	 ...
	 */
	Navigation.prototype.next = function(speed, slideByOne) {
		$.proxy(this._overrides.to, this._core)(this.getPosition(true, slideByOne), speed);
	};
	 ...
	 * @param {Number} [speed=false] - The time in milliseconds for the transition.
	 */
	Navigation.prototype.prev = function(speed, slideByOne) {
		$.proxy(this._overrides.to, this._core)(this.getPosition(false, slideByOne), speed);
	};
